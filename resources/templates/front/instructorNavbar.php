<div class="container">
    <a class="navbar-brand" href="instructorIndex.php">
        <img src="img/logo.png" style="width: 150px;" alt=""></a>
    <br>

    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ms-auto">
            <a class="nav-link mx-2" aria-current="page" href="addsubject.php">Add Section <svg
            ...
            <a class="nav-link mx-2" href="cancelInstructorSection.php">Cancel Section <svg
                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-dash-circle" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                    <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z" />
                </svg></a>
            <a class="nav-link mx-2" href="addcourse.php">Add Course <svg xmlns="http://www.w3.org/2000/svg"
